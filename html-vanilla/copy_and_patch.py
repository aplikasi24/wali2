...
# Set relative paths so it works regardless of folder name (e.g. manajemen-wali-kelasOK)
src = os.path.join(os.path.dirname(__file__), "..", "appscript_backend", "app_logic.html")
dst = os.path.join(os.path.dirname(__file__), "app_logic.js")
